...
----------------------------------------------------------------------------
Java_console, ver. 2.2.3 (2019-08-22)

1) The error related to incorrect counting of rows of a database's table has been fixed.
2) Some grammar mistakes have been fixed in the program. Should be working better now than it would in the past.
...
P.S.:
So far, there has been an insoluble issue related to Cyrillic names in a Windows path when using the "new File(path).listFiles()" instruction (whilst Linux is perfectly okay). And I don't figure out how to fix it yet. :-( Follow https://ru.stackoverflow.com/questions/500668/������-��������-�����-��-��-�������-����-�-����
